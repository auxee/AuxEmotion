...
namespace AuxEmotion.Configuration.Data
{
    public class ReactionData
    {
        ...
        public int responseMacroBook = 0;
        public int responseMacroSlot = 0;
        ...
        public void CopyValue(ReactionData value)
        {
            ...
            responseMacroBook = value.responseMacroBook;
            responseMacroSlot = value.responseMacroSlot;
